...
function openLoginModal() {
    ...
    function redirectUser(userType) {
      // Define the redirect URLs for each user type
      const redirectUrls = {
        'customer': '../../customer/signin/signin.html',
        'travelling-company': '../../travelling_company/signin/signin.html',
        'receptionist': '../../receptionist/signin/signin.html',
        'manager': '../../manager/signin/signin.html',
        'admin': '../../admin/signin/signin.html'
      };
